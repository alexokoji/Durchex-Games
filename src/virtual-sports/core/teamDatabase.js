...
exports.TEAMS_BY_ID = exports.TEAMS = exports.getPersonality = void 0;
exports.getTeam = getTeam;
exports.teamsByLeague = teamsByLeague;
exports.teamStrength = teamStrength;
var teamPersonalities_1 = require("./teamPersonalities");
Object.defineProperty(exports, "getPersonality", { enumerable: true, get: function () { return teamPersonalities_1.getPersonality; } });
function mk(args) {
    return {
        id: args.id,
        name: args.name,
...
exports.TEAMS_BY_ID = exports.TEAMS.reduce((acc, t) => {
    acc[t.id] = t;
    return acc;
}, {});
function getTeam(id) {
    return exports.TEAMS_BY_ID[id];
}
function teamsByLeague(leagueId) {
    return exports.TEAMS.filter(t => t.leagueId === leagueId);
}
...
//# sourceMappingURL=teamDatabase.js.map