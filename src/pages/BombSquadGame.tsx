...
export default function BombSquadGamePage() {
  ...
  const playGame = async () => {
    ...
    try {
      ...
      const bet = await wallet.placeBet({ gameId: 'bombsquad', gameName: 'Bomb Squad', stake });
      if (bet)
